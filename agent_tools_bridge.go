...
// output shapes — is identical on both paths. These tools live in
// the deferred tool registry (agent_tools_registry.go): they are
// never part of the wire tool definitions and are reached through
